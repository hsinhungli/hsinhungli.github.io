...
var sig_x  = 64;
var sig_y  = 64;
var group  = 2; //Math.floor(runif(1,3)); for 1 and 2, use runif(1,3), etc.
var center = new Array(400, 250);
var expPar = {ntrlPerConfig : 2, ITI : 600, nconfig : 4, delayBfResponse : 500, ntrl_pb: 8}; //ntrl_pb: ntrial per block
var stiPar = {dotradius : 1.8, targetradius : 2.3, ndot : 375};
var screen_sizex = 800;
var screen_sizey = 500;
...
function CheckBrowserSize() {
	if(navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/BlackBerry/i)) {
		...
		if (scr.window_height < 600 || scr.window_width < 800) {
			alert('Please make your window bigger. And press the Check button again.\n If you still cannot pass the test after enlarging the window size,\n please try use a different browser to run the task.');
		}
		else {
